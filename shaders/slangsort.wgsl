...
fn main(@builtin(global_invocation_id) threadId_0 : vec3<u32>)
{
    ...
    var _S1 : u32 = array_index_0 % u32(256);
    if(array_index_0 >= (array_info_0.num_arrays_0))
    {
        return;
    }
    var _S2 : u32 = array_index_0 * array_info_0.array_size_0;
    var i_0 : u32 = u32(0);
    for(;;)
    {
        ...
        local_arrays_0[_S1][i_0] = array_buffer_0[_S2 + i_0];
        i_0 = i_0 + u32(1);
    }
    i_0 = u32(0);
    for(;;)
    {
        ...
        for(;;)
        {
            ...
            local_arrays_0[_S1][i_0] = local_arrays_0[_S1][i_0] + u32(1);
            j_0 = j_0 + u32(1);
        }
        i_0 = i_0 + u32(1);
    }
    ...
    for(;;)
    {
        ...
        array_buffer_0[_S2 + i_0] = local_arrays_0[_S1][i_0];
        i_0 = i_0 + u32(1);
    }
    return;
}
